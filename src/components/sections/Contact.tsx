            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  variant="hero"
                  size="lg"
                  className="flex-1 min-h-12 h-14 sm:h-12"
                ...
                <Button
                  ...
                  className="flex-1 min-h-12 h-14 sm:h-12 border-green-500 text-green-600 hover:bg-green-50 hover:text-green-700"
                >
                  <svg viewBox="0 0 24 24" className="w-5 h-5 shrink-0 mr-2" fill="currentColor">
