...
import { HERO, COMPANY } from "@/constants";
    ...
    <section id="home" className="relative min-h-screen flex items-center gradient-hero overflow-hidden">
      ...
      <div className="container-width relative z-10 pt-24 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Sparkles size={16} />
            <span>{COMPANY.clients} Clients Trust Us</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-gradient-sunny">
          ...
          >
            {HERO.stats.map((stat, index) => (
              ...
              >
                <div className="font-display text-3xl md:text-4xl font-bold text-gradient-sunny">
                  {stat.value}
                </div>
